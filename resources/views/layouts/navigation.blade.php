<nav class="fixed top-0 left-0 z-50 w-full bg-white shadow-sm">
    <div class="flex items-center justify-between px-6 py-4 mx-auto max-w-7xl">
        ...
        <div class="flex items-center space-x-2">
            ...
            <div class="text-lg font-bold leading-tight text-green-800">
                Pineus Tilu<br>
                <span class="text-xs font-normal">Rancabali – Pangalengan</span>
            </div>
        </div>

        <!-- Desktop Menu -->
        <ul class="items-center hidden space-x-8 font-medium text-green-800 font-typewriter md:flex">
            <li>
            ...
            <li class="relative">
                ...
                <ul id="dropdownMenu" class="absolute left-0 z-50 hidden w-48 mt-2 space-y-2 text-sm text-green-800 bg-white border rounded shadow-md">
            ...
            <li><a href="/login" class="px-4 py-2 text-white transition bg-[#006C43] rounded-md hover:bg-green-700">Login/Register</a></li>
        </ul>
    ...
    <!-- Mobile Menu -->
    <div id="mobile-menu" class="hidden px-6 pt-2 pb-4 space-y-2 text-green-800 bg-white border-t md:hidden font-typewriter">
