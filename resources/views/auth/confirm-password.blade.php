<x-guest-layout>
    @section('title', 'Konfirmasi Password - Pineus Tilu Riverside Camping Ground')
    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#006C43] via-[#00844D] to-[#005A36] px-4 py-8 relative overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute top-1/3 left-1/3 w-32 h-32 bg-white/5 rounded-full animate-pulse"></div>
            <div class="absolute bottom-1/3 right-1/3 w-24 h-24 bg-white/10 rounded-full animate-ping"></div>
        </div>
