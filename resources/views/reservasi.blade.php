            ...
            <form action="{{ route('detailpembelian') }}" method="POST" class="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="flex flex-col items-start mb-2">
                        <div class="text-sm text-green-700">Tambahan</div>
                        <div class="text-sm" id="tambahan-harga">Rp 0</div>
                        <div class="text-lg font-bold text-green-900" id="total-harga">
                            <span class="font-semibold">Total</span><br>Rp 0
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <button type="submit"
                        class="w-full py-2 font-semibold text-white transition bg-green-600 rounded hover:bg-green-700">Pesan
                        Sekarang</button>
                </div>
            </form>
        </div>
