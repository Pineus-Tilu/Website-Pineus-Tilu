...
<section class="relative flex items-center justify-center min-h-screen px-4 py-20 text-white bg-center bg-cover bg-fixed pt-[64px] sm:pt-[80px] md:pt-[96px] lg:pt-[112px] mt-14 sm:mt-18 md:mt-22 lg:mt-26"
