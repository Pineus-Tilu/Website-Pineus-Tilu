...
<section class="relative py-12 md:py-20 bg-gradient-to-br from-gray-50 via-green-50 to-blue-50 overflow-hidden" 
         data-aos="fade-up" 
    ...
    <div class="absolute inset-0 opacity-5">
        ...
        <div class="absolute bottom-1/4 left-1/4 w-24 h-24 sm:w-32 sm:h-32 md:w-48 md:h-48 rounded-full bg-blue-400 animate-pulse delay-1000"></div>
        <div class="absolute top-1/2 left-1/2 w-16 h-16 sm:w-20 sm:h-20 md:w-32 md:h-32 rounded-full bg-green-200 animate-pulse delay-500"></div>
    </div>
    ...
    <div class="container relative z-10 px-4 mx-auto max-w-7xl">
        ...
        <div class="grid lg:grid-cols-2 gap-8 md:gap-12 items-start">
            ...
            <div class="space-y-6 md:space-y-8" data-aos="fade-right" data-aos-delay="500">
                <!-- Address Card -->
                <div class="bg-white rounded-xl md:rounded-2xl p-6 md:p-8 shadow-lg border border-green-100 hover:shadow-2xl hover:border-green-200 transition-all duration-300 group">
                    <div class="flex items-start space-x-3 md:space-x-4">
                        <div class="flex-shrink-0 w-12 h-12 md:w-14 md:h-14 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center space-x-2 text-sm text-green-600">
                                ...
                                <span class="font-medium">Buka 24 jam</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-6 md:space-y-8" data-aos="fade-left" data-aos-delay="600">
                <!-- Map -->
                <div class="relative">
                    <div class="relative bg-white rounded-xl md:rounded-2xl p-3 md:p-4 shadow-lg border border-green-100 hover:shadow-2xl hover:border-green-200 transition-all duration-300 group">
                        <div class="relative overflow-hidden rounded-lg md:rounded-xl aspect-video cursor-pointer" @click="openMapModal()">
                            <iframe src="https://maps.google.com/maps?q=Pineus%20Tilu&t=&z=15&ie=UTF8&iwloc=&output=embed"
                                class="w-full h-full border-0 rounded-lg md:rounded-xl transition-transform duration-300 group-hover:scale-105 pointer-events-none" 
                                title="Pineus Tilu Location Map"
                                loading="lazy"></iframe>
                            
                            <!-- Map Overlay -->
                            <div class="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg md:rounded-xl flex items-center justify-center">
                                <div class="text-center text-white">
                                    <div class="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mb-3 mx-auto backdrop-blur-sm">
                ...
                <!-- Action Buttons - Centered below map -->
