...
<div class="max-w-full overflow-hidden">
    ...
    <section class="relative" data-aos="fade-up">
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center px-4 text-center text-white">
            ...
            <p class="mb-8 text-xl font-typewriter max-w-2xl">
                Pesan sekarang untuk merasakan pengalaman camping yang tak terlupakan di pinggir sungai!
            </p>
            <a href="/reservasi"
                class="inline-flex items-center px-8 py-4 text-xl font-semibold text-white bg-gradient-to-r from-green-600 to-green-700 rounded-full shadow-lg hover:from-green-700 hover:to-green-800 transform hover:scale-105 transition-all duration-300 font-typewriter">
