<!-- Fasilitas Section -->
<section class="bg-gradient-to-br from-[#006C43] via-[#00844D] to-[#005A36] text-white py-20 px-4 font-body relative overflow-hidden" data-aos="fade-up">
    ...
    <div class="max-w-6xl mx-auto relative z-10">
        <h2 class="mb-12 text-4xl font-bold text-center  drop-shadow-lg" style="font-family: 'Segoe UI', 'Roboto', Arial, sans-serif; font-weight: 700;" data-aos="fade-down">Fasilitas Tersedia</h2>
        ...
        <div class="mb-12 p-8 bg-white bg-opacity-15 backdrop-blur-md rounded-2xl border border-white border-opacity-20 shadow-2xl" data-aos="fade-up" data-aos-delay="100">
            <div class="text-center">
                <h3 class="mb-4 text-3xl font-bold  text-white drop-shadow-md" style="font-family: 'Segoe UI', 'Roboto', Arial, sans-serif; font-weight: 700;">💎 Kapasitas</h3>
        ...
        <div class="grid gap-8 lg:grid-cols-2">
            ...
            <div class="p-8 bg-white bg-opacity-15 backdrop-blur-md rounded-2xl border border-white border-opacity-20 shadow-xl hover:bg-opacity-20 transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-right" data-aos-delay="200">
                <div class="flex items-center mb-6">
                    ...
                    <h3 class="text-2xl font-bold  text-white drop-shadow-md" style="font-family: 'Segoe UI', 'Roboto', Arial, sans-serif; font-weight: 700;">🏠 Fasilitas Pribadi</h3>
                </div>
            ...
            <div class="p-8 bg-white bg-opacity-15 backdrop-blur-md rounded-2xl border border-white border-opacity-20 shadow-xl hover:bg-opacity-20 transition-all duration-300 transform hover:-translate-y-2" data-aos="fade-left" data-aos-delay="200">
                <div class="flex items-center mb-6">
                    ...
                    <h3 class="text-2xl font-bold  text-white drop-shadow-md" style="font-family: 'Segoe UI', 'Roboto', Arial, sans-serif; font-weight: 700;">🌍 Fasilitas Umum</h3>
                </div>
